...
<div class="col-lg-{{ $col }} mb-{{$margin}}">
    ...
    <div
            ...
            id="lfm2"
            data-path="path"
            data-preview-wrapper="preview-multiple"
    ...
    >
        ...
        <input type="hidden" value="" id="image_icon_url" name="{{ $name }}" {{ $required ? 'required' : '' }}>
    </div>
    @error('image_icon_url')<p style="color: #fd625e; font-size: 80%; margin-top: 4px">Image Field is required</p>@enderror
</div>
